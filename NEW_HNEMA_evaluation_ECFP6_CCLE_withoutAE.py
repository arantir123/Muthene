...
def run_model_HNEMA_DDI(root_prefix, hidden_dim_main, num_heads_main, attnvec_dim_main, rnn_type_main,
                        ...
                        hidden_dim_aux, layer_list, pred_in_dropout, pred_out_dropout, output_concat, whether_CCLE, args):

    print('output_concat, whether_CCLE, hidden_dim_aux, rnn_type_main:', output_concat, whether_CCLE, hidden_dim_aux, rnn_type_main)
    ...
    for _ in range(repeat):
        ...
        optimizer = torch.optim.Adam(
            itertools.chain(main_net.parameters(), te_net.parameters()),
        ...
        tot_params2 = sum([np.prod(p.size()) for p in te_net.parameters()])
...
if __name__ == '__main__':
    ...
    run_model_HNEMA_DDI(args.root_prefix, args.hidden_dim_main, args.num_heads_main, args.attnvec_dim_main, args.rnn_type_main, args.epoch,
                        ...
                        args.layer_list, args.pred_in_dropout, args.pred_out_dropout, args.output_concat, args.whether_CCLE, args)
