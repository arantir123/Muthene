...
Step3. __Follow the instruction in each following .py file to read the model input generated by above two .ipynb files (e.g., files in provided 'fold1') and then execute different variants described in the manuscript:__
